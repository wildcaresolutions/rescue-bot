...
```
AI_GATEWAY_TOKEN=...               # Cloudflare AI Gateway BYOK auth
...
PHOTO_RECOGNIZER_MODEL=openai/gpt-4.1-mini   # vision; needs BYOK alias
...
```bash
# AI Gateway token — generate a new one in dash.cloudflare.com → AI Gateway → BYOK
