...
export interface Env {
  ...
  AI_GATEWAY_GOOGLE_BYOK_ALIAS?: string
  AI_GATEWAY_OPENAI_BYOK_ALIAS?: string
  AI_GATEWAY_ANTHROPIC_BYOK_ALIAS?: string
  /** Direct Anthropic API key. When set, the admin assistant uses it
   * directly instead of routing through Cloudflare AI Gateway BYOK.
   * Pushed via `wrangler secret put ANTHROPIC_API_KEY`. */
