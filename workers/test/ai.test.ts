...
import {
  ...
  DEFAULT_GOOGLE_AI_GATEWAY_BYOK_ALIAS,
  DEFAULT_MAIN_CHAT_MODEL,
  DEFAULT_OPENAI_AI_GATEWAY_BYOK_ALIAS,
...
describe('ai provider config', () => {
  ...
  it('does not force a BYOK alias when the gateway can use its default stored key', () => {
    expect(DEFAULT_GOOGLE_AI_GATEWAY_BYOK_ALIAS).toBe('')
    expect(DEFAULT_OPENAI_AI_GATEWAY_BYOK_ALIAS).toBe('')
    expect(DEFAULT_ANTHROPIC_AI_GATEWAY_BYOK_ALIAS).toBe('')
  })
